...
var timeout = 15; // Server message timeout in minutes
...
"!search [website] [arguments] - Returns a formatted search URL for the given site\n" +
        ...
        switch(cmd) {
            ...
            case 'boilerplate':
                try {
                    ...
                    msg(channelID, 'Message send attempt to: UNKNOWN USER ID');
                    sendBoiler(args[2], args[0], args[1]);
                }
                deleteMessage(channelID, evt.d.id);
                break;
